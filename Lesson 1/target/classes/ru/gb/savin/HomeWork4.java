...
public class HomeWork4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Цель игры - заполнить подряд линию по вертикали, горизонтали или диагонали из %d Ваш%s символ%s.\n",
                DOTS_TO_WIN, (DOTS_TO_WIN % 10 == 1 && DOTS_TO_WIN % 100 != 11) ? "его" :
                        "их", (DOTS_TO_WIN % 10 == 1 && DOTS_TO_WIN % 100 != 11) ? "а" : "ов");
        printGameField();

        switch (new Random().nextInt(2)) {
            case 0: {
                System.out.println("Человек твой ход первый!");
                while (true) {
                    player1Move();
                    printGameField();
                    ...
                    if (isWin(PLAYER_2_DOT)) {
                        System.out.println("Компьютер забрал победу");
                        break;
                    }
                    if (isDraw()) {
                        System.out.println("Ничья");
